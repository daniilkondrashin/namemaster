...
Common labels
*/}}
{{- define "namemaster.labels" -}}
helm.sh/chart: {{ include "namemaster.chart" . }}
{{ include "namemaster.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "namemaster.selectorLabels" -}}
